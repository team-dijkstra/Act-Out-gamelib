...
class Unit {
  public:
   ...
   ///
   /// \details increases the count in this object by u
   ///
   ...
   ///
   /// \details decreases the count in this object by u
   ///
   ...
   ///               defaults to 1
   ///
   /// \details count of this Unit is decreased by num, returned Unit can do an
   ...
   ///
   /// \details this Unit now has count increased by the count of u, u is deleted
   ///
